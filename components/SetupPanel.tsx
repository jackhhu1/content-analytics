          ...
          <div className="flex gap-2 pt-1">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full bg-black/40 border border-white/5 rounded-lg pl-8 pr-3 py-1.5 text-xs text-white placeholder-slate-600 focus:outline-none focus:border-indigo-500 transition-colors"
              />
            </div>
            <select
              value={sortBy}
              onChange={e => setSortBy(e.target.value as 'recent' | 'followers' | 'az')}
              className="bg-black/40 border border-white/5 text-slate-300 text-xs rounded-lg px-2.5 py-1.5 focus:outline-none focus:border-indigo-500 transition-colors appearance-none cursor-pointer pr-6"
